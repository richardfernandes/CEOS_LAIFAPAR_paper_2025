...
def SL2PCCRS(samplesDF,variableName,imageCollectionName):
...
def SL2PINRA(samplesDF,variableName,imageCollectionName):
    ...
    results = apply_net(samplesDF,variableName,imageCollectionName,algorithm)
    print(results.shape)
    return results
